...
class Play4 extends Component {
  ...
  getAudio() {
    axios.get(`${process.env.REACT_APP_API_URL}/my-audios?audio_three`)
    .then(resAudio =>{
    ...
    return (
      <div>
        <div className="full-page-white">
          ...
          <Link to='/q3'><img img className='next-image' src={next} alt="next"/></Link>
        </div>
        <img className="legend" src={legend3} alt="progress"/>
       <Footer />
      </div>
    )
  }
